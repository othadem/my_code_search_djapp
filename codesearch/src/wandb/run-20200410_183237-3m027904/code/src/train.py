...
from src import model_restore_helper
from src.model_test import compute_evaluation_metrics
from src.models.model import Model
from src import model_test as test
...
def run(arguments, tag_in_vcs=False) -> None:
    ...
    print("going to train for {} number of epochs ".format(int(arguments.get('--max-num-epochs'))))

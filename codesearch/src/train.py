...
from codesearch.src.model_test import compute_evaluation_metrics
from codesearch.src.models.model import Model
from codesearch.src import model_test as test
...
def run(arguments = {}, tag_in_vcs=False) -> None:
    ...
    arguments['TRAIN_DATA_PATH'] = False
    arguments['SAVE_FOLDER'] = False
    arguments['--model'] = "neuralbow"
    arguments['--max-num-epochs'] = 5
    ...
    hyperparameters['max_epochs'] = int(arguments['--max-num-epochs'])
    print("going to train for {} number of epochs ".format(int(hyperparameters['max_epochs'])))
    ...
    hypers_override = None #arguments.get('--hypers-override')
    '''
    ...
    if arguments.get('--evaluate-model'):
        ...
        model_path = run_train(model_class, train_data_dirs, valid_data_dirs, save_folder, hyperparameters,
                               ...
                               parallelize=(arguments['--sequential']))

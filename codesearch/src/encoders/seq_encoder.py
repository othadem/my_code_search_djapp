...
from codesearch.src.utils.bpevocabulary import BpeVocabulary
# from dpu_utils.mlutils.bpevocabulary import BpeVocabulary
from codesearch.src.utils.tfutils import convert_and_pad_token_sequence
